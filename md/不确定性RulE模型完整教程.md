...
│  ║                              ↓                                  ║  │
│  ║  ┌────────────────────────────────────────────────────────┐   ║  │
│  ║  │  【规则Grounding机制】(model.py:731-909)               │   ║  │
│  ║  │                                                          │   ║  │
│  ║  │  查询: (h, r, ?)                                        │   ║  │
│  ║  │      ↓                                                  │   ║  │
│  ║  │  检索适用规则: rules = relation2rules[r]               │   ║  │
│  ║  │      ↓                                                  │   ║  │
│  ║  │  ┌─────────────────────────────────────────────────┐  │   ║  │
│  ║  │  │ 【方式1】硬Grounding (默认, data.py:410-421)    │  │   ║  │
│  ║  │  │ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ 输入: 头实体h, 规则体[r_1, r_2, ..., r_n]      │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ 初始化:                                          │  │   ║  │
│  ║  │  │   x = one_hot(h, num_entities)  # [E, B, 1]    │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ For each relation r_j in rule_body:             │  │   ║  │
│  ║  │  │   ┌─────────────────────────────────┐           │  │   ║  │
│  ║  │  │   │ graph.propagate(x, r_j)          │           │  │   ║  │
│  ║  │  │   │                                   │           │  │   ║  │
│  ║  │  │   │ 只使用观察边 (KG中真实存在的边) │           │  │   ║  │
│  ║  │  │   │                                   │           │  │   ║  │
│  ║  │  │   │ 消息传播:                        │           │  │   ║  │
│  ║  │  │   │   message = x[node_in]           │           │  │   ║  │
│  ║  │  │   │   x = scatter(message, node_out) │           │  │   ║  │
│  ║  │  │   └─────────────────────────────────┘           │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ 输出: count [batch, num_entities] (整数)        │  │   ║  │
│  ║  │  │       每个实体的精确路径计数                     │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ 特点:                                            │  │   ║  │
│  ║  │  │ ✓ 确定性: 基于已知事实                          │  │   ║  │
...
│  ║  │      ↓                                                  │   ║  │
│  ║  │  ┌─────────────────────────────────────────────────┐  │   ║  │
│  ║  │  │ 【方式2】软Grounding (可选, model.py:564-628)   │  │   ║  │
│  ║  │  │ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ 启用条件: use_soft_grounding=True + soft_topb>0 │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ 【步骤1】预计算KGE预测边 (build_soft_pred_edges)│  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ For each relation r in [0, 2*num_relations):    │  │   ║  │
│  ║  │  │   For each entity h:                             │  │   ║  │
│  ║  │  │     scores = RotatE(h, r, all_entities)         │  │   ║  │
│  ║  │  │     topB_tails, topB_scores = topk(scores, B)   │  │   ║  │
│  ║  │  │     weights = η × sigmoid(topB_scores / τ)      │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │     存储: (h, topB_tails, weights)              │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ 参数:                                            │  │   ║  │
│  ║  │  │   - soft_topb (B): top-K预测边数量 (如50)       │  │   ║  │
│  ║  │  │   - soft_eta (η): 预测边权重系数 (如0.3)        │  │   ║  │
│  ║  │  │   - soft_temp (τ): sigmoid温度参数 (如1.0)      │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ 【步骤2】混合传播 (soft_grounding_count)        │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ 初始化:                                          │  │   ║  │
│  ║  │  │   x = one_hot(h, num_entities)  # [E, B, 1]    │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
...
│  ║  │  │   │                                     │        │  │   ║  │
│  ║  │  │   │ 死路检测:                          │        │  │   ║  │
│  ║  │  │   │   dead = (x_real.sum(dim=0) == 0)  │        │  │   ║  │
│  ║  │  │   │                                     │        │  │   ║  │
│  ║  │  │   │ 稀疏检测 (如果soft_real_kmin > 0): │        │  │   ║  │
│  ║  │  │   │   support = (x_real > 0).sum()     │        │  │   ║  │
│  ║  │  │   │   sparse = (support < kmin)        │        │  │   ║  │
│  ║  │  │   │                                     │        │  │   ║  │
│  ║  │  │   │ 决策逻辑:                          │        │  │   ║  │
│  ║  │  │   │   if soft_only_on_deadend:         │        │  │   ║  │
│  ║  │  │   │     use_pred = dead  (只在死路)    │        │  │   ║  │
│  ║  │  │   │   elif soft_real_kmin > 0:         │        │  │   ║  │
│  ║  │  │   │     use_pred = sparse (稀疏时)     │        │  │   ║  │
│  ║  │  │   │   else:                             │        │  │   ║  │
│  ║  │  │   │     use_pred = True (总是使用)     │        │  │   ║  │
│  ║  │  │   └────────────────────────────────────┘        │  │   ║  │
│  ║  │  │   ┌────────────────────────────────────┐        │  │   ║  │
│  ║  │  │   │ Step C: 预测边传播 (if use_pred)  │        │  │   ║  │
│  ║  │  │   │                                     │        │  │   ║  │
│  ║  │  │   │ x_pred = Σ (x[h] × weight × I_hrt) │        │  │   ║  │
│  ║  │  │   │          (从预计算的软边)          │        │  │   ║  │
│  ║  │  │   │                                     │        │  │   ║  │
│  ║  │  │   │ 混合传播结果:                      │        │  │   ║  │
│  ║  │  │   │   x = x_real + use_pred × x_pred   │        │  │   ║  │
│  ║  │  │   └────────────────────────────────────┘        │  │   ║  │
│  ║  │  │   ┌────────────────────────────────────┐        │  │   ║  │
│  ║  │  │   │ Step D: Beam剪枝 (可选)            │        │  │   ║  │
│  ║  │  │   │   if soft_beam > 0:                │        │  │   ║  │
...
│  ║  │  │   └────────────────────────────────────┘        │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ 输出: count [batch, num_entities] (浮点数)      │  │   ║  │
│  ║  │  │       包含概率性路径的软计数                     │  │   ║  │
│  ║  │  │                                                   │  │   ║  │
│  ║  │  │ 特点:                                            │  │   ║  │
│  ║  │  │ ✓ 缓解稀疏性: 通过KGE补充缺失边                 │  │   ║  │
│  ║  │  │ ✓ 灵活性: 可配置何时使用预测边                  │  │   ║  │
│  ║  │  │ ✓ 效率优化: Beam搜索减少计算量                  │  │   ║  │
│  ║  │  │ ✗ 可解释性稍弱: 包含模型预测的"虚拟"路径        │  │   ║  │
│  ║  │  └─────────────────────────────────────────────────┘  │   ║  │
│  ║  │      ↓                                                  │   ║  │
│  ║  │  规则特征聚合 (rule_to_entity):                        │   ║  │
│  ║  │    mlp_feature_weighted = mlp_feature × rule_mu       │   ║  │
│  ║  │    output = Σ (count × mlp_feature_weighted)          │   ║  │
│  ║  │      ↓                                                  │   ║  │
│  ║  │  MLP打分: scores = score_model(output)                │   ║  │
│  ║  └────────────────────────────────────────────────────────┘   ║  │
│  ║                              ↓                                  ║  │
